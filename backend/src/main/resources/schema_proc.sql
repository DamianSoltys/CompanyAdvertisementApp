...
BEGIN
    ...
    drop table if exists fb_social_profiles;
    drop table if exists fb_tokens;
    drop table if exists fb_token_scopes;
    drop table if exists promotion_item_destinations;
    drop table if exists destination_arrivals;
    ...
    (
        facebook_social_profile_id bigint auto_increment primary key,
        created_at                 timestamp default current_timestamp()   not null,
        modified_at                timestamp default '0000-00-00 00:00:00' not null on update current_timestamp(),
        company_id                 bigint                                  not null,
        platform_id                smallint(6)                             not null,
